...
<html lang=\"en\">
  ...
  <body>
    ...
    <div class=\"container\">
      ...
      <form class=\"form-signin\" id=\"FLogin\" action=\"../Controller/DefaultController.php\" method=\"POST\">
        <h2 class=\"form-signin-heading\">Ingresar</h2>
        <input type=\"text\" class=\"input-block-level\" placeholder=\"Nombre de usuario\">
